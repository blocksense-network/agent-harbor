...
_(FYI, the project also documents which default keys map to which actions; if you’re replicating those bindings manually, that table is a handy reference.)_ ([github.com][2])
