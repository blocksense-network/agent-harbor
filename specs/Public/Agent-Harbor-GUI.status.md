...
- **URL Handler**: Rust binary per [Handling-AW-URL-Scheme.status.md](Handling-AW-URL-Scheme.status.md)
...
- **URL Scheme Track**: Protocol handler implementation (see [Handling-AW-URL-Scheme.status.md](Handling-AW-URL-Scheme.status.md))
...
- **Cross-Spec Dependencies**:
  - **[Handling-AW-URL-Scheme.status.md](Handling-AW-URL-Scheme.status.md)**: Standalone handler for headless systems
