...
**Goal**
Fulfill the `Backstore` trait with an **in-memory** simulation that behaves _exactly_ like a future real APFS volume (same error codes, same latency model, same reflink semantics).
