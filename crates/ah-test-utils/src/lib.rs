...
extern crate self as ah_test_utils;

pub mod guard;
pub mod logging;
pub mod macros;

pub use ah_test_utils_macros::{logged_test, logged_tokio_test};
pub use guard::TestLoggerGuard;
...
mod tests {
    ...
    fn test_logging_creates_unique_files() {
        logger.log("creating unique log files").unwrap();
        ...
        logger.log("validated unique log file creation").unwrap();
    }
