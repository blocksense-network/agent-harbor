        ...
        pub async fn run(&self) -> Result<(), ServerError> {
            ...
            let handler = move |request: Request| {
                ...
                async move {
                    ...
                    // Auto-respond to handshake requests (other requests are one-way)
                    match request {
                        ...
                        Request::CommandStart(_) | Request::CommandChunk(_) => {
                            // CommandStart and CommandChunk are notifications, no response needed
                            None
                        }
                    }
                }
