// Test program to validate split mode configuration functionality
...
impl serde::Serialize for SplitMode {
        ...
        S: serde::Serializer,
    {
        match self {
            ...
            SplitMode::Horizontal => serializer.serialize_str("horizontal"),
            SplitMode::Vertical => serializer.serialize_str("vertical"),
            SplitMode::Auto => serializer.serialize_str("auto"),
        }
    }
}
...
impl<'de> serde::Deserialize<'de> for SplitMode {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        match s.as_str() {
            ...
            _ => Err(serde::de::Error::custom(format!("Unknown split mode: {}", s))),
        }
    }
}
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("📁 Using temporary config path: {}", config_path.display());
