...
#[tokio::test]
async fn test_mock_task_manager_validates_empty_description() {
    let manager = MockTaskManager::new();
    let params = TaskLaunchParams {
        repository: "test/repo".to_string(),
        branch: "main".to_string(),
...
#[tokio::test]
async fn test_mock_task_manager_validates_empty_models() {
    let manager = MockTaskManager::new();
    let params = TaskLaunchParams {
        repository: "test/repo".to_string(),
        branch: "main".to_string(),
...
#[tokio::test]
async fn test_mock_task_manager_handles_simulated_failures() {
